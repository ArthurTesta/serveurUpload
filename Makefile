...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Sat Dec 1 14:56:16 2012
...
SOURCES       = main.cpp \
		...
		medialist.cpp \
		receivethread.cpp \
		protocol.cpp moc_mainwindowservfinal.cpp \
		moc_serveurtcp.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/serveurFinal1.0.0/ && $(COPY_FILE) --parents mainwindowservfinal.h serveurtcp.h media.h medialist.h receivethread.h serverexception.h protocol.h .tmp/serveurFinal1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindowservfinal.cpp serveurtcp.cpp media.cpp medialist.cpp receivethread.cpp protocol.cpp .tmp/serveurFinal1.0.0/ && $(COPY_FILE) --parents mainwindowservfinal.ui .tmp/serveurFinal1.0.0/ && (cd `dirname .tmp/serveurFinal1.0.0` && $(TAR) serveurFinal1.0.0.tar serveurFinal1.0.0 && $(COMPRESS) serveurFinal1.0.0.tar) && $(MOVE) `dirname .tmp/serveurFinal1.0.0`/serveurFinal1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/serveurFinal1.0.0
...
protocol.o: protocol.cpp protocol.h \
		serverexception.h \
		../clientUpload/mainwindow.h \
		../clientUpload/serverexception.h \
		receivethread.h \
		medialist.h \
		media.h
