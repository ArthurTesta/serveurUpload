...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Sun Dec 2 19:44:08 2012
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/serveurFinal1.0.0/ && $(COPY_FILE) --parents mainwindowservfinal.h serveurtcp.h media.h medialist.h receivethread.h protocol.h exception.h .tmp/serveurFinal1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindowservfinal.cpp serveurtcp.cpp media.cpp medialist.cpp receivethread.cpp protocol.cpp .tmp/serveurFinal1.0.0/ && $(COPY_FILE) --parents mainwindowservfinal.ui .tmp/serveurFinal1.0.0/ && (cd `dirname .tmp/serveurFinal1.0.0` && $(TAR) serveurFinal1.0.0.tar serveurFinal1.0.0 && $(COMPRESS) serveurFinal1.0.0.tar) && $(MOVE) `dirname .tmp/serveurFinal1.0.0`/serveurFinal1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/serveurFinal1.0.0
